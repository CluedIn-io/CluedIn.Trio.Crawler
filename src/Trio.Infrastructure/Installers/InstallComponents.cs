...
namespace CluedIn.Crawling.Trio.Infrastructure.Installers
{
    public class InstallComponents : IWindsorInstaller
    {
        public void Install(IWindsorContainer container, IConfigurationStore store)
        {
            container
                ...
                .Register(Component.For<ITrioClientFactory>().AsFactory())
                .Register(Component.For<TrioClient>().LifestyleTransient());
