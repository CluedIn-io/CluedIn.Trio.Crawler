...
using DebugCrawlerHost = CrawlerIntegrationTesting.CrawlerHost.DebugCrawlerHost<CluedIn.Crawling.Trio.Core.TrioCrawlJobData>;

namespace CluedIn.Crawling.Trio.Integration.Test
{
    public class TrioTestFixture
    {
        public ClueStorage ClueStorage { get; }
        private readonly DebugCrawlerHost debugCrawlerHost;

        public TestLogger Log { get; }
        public TrioTestFixture()
        {
            var executingFolder = new FileInfo(Assembly.GetExecutingAssembly().CodeBase.Substring(8)).DirectoryName;
            debugCrawlerHost = new DebugCrawlerHost(executingFolder, TrioConstants.ProviderName);
            ...
            debugCrawlerHost.Execute(TrioConfiguration.Create(), TrioConstants.ProviderId);
        }
