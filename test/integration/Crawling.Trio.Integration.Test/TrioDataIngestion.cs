...
{
    public class DataIngestion : IClassFixture<TrioTestFixture>
    {
        private readonly TrioTestFixture fixture;
        private readonly ITestOutputHelper output;

        public DataIngestion(TrioTestFixture fixture, ITestOutputHelper output)
        {
